...
from ..data.senegal_data import SENEGAL_UNIVERSITIES, SENEGAL_COMPANIES, SENEGAL_JOBS

# Création du Blueprint pour les routes API Sénégal
senegal_api = Blueprint('senegal_api', __name__)

# Route pour obtenir toutes les universités sénégalaises
@senegal_api.route('/api/senegal/universities', methods=['GET'])
...
@senegal_api.route('/api/senegal/universities/<string:university_id>', methods=['GET'])
...
@senegal_api.route('/api/senegal/companies', methods=['GET'])
def get_companies():
...
@senegal_api.route('/api/senegal/companies/<string:company_id>', methods=['GET'])
...
@senegal_api.route('/api/senegal/jobs', methods=['GET'])
def get_jobs():
...
@senegal_api.route('/api/senegal/jobs/<string:job_id>', methods=['GET'])
def get_job(job_id):
...
@senegal_api.route('/api/senegal/job-stats', methods=['GET'])
def get_job_stats():
...
@senegal_api.route('/api/senegal/jobs/search', methods=['GET'])
def search_jobs():
...
@senegal_api.route('/api/senegal/industries', methods=['GET'])
def get_industries():
...
@senegal_api.route('/api/senegal/study-programs', methods=['GET'])
